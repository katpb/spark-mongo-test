...
/**
 * Extended SHA256 implementation that takes text length upto 2^64 -1.
 */
public class Sha256 extends HashBase {
	private static final int k[] = { 0x428a2f98, 0x71374491, 0xb5c0fbcf,
			...
			0xfc19dc6, 0x240ca1cc, 0x2de92c6f, 0x4a7484aa, 0x5cb0a9dc,
			0x76f988da, 0x983e5152, 0xa831c66d, 0xb00327c8, 0xbf597fc7,
			0xc6e00bf3, 0xd5a79147, 0x6ca6351, 0x14292967, 0x27b70a85,
	...
	private static final synchronized int[] sha(int hh0, int hh1, int hh2,
		...
		for (int r = 0; r < 64; r++) {
			int T = H
					...
					+ (E & F ^ ~E & G) + k[r] + w[r];
			int T2 = ((A >>> 2 | A << 30) ^ (A >>> 13 | A << 19) ^ (A >>> 22 | A << 10))
					+ (A & B ^ A & C ^ B & C);
			H = G;
			G = F;
			F = E;
