...
/* tag 33881, 33882, and 33884 are private tags registered to Unisys */
	...
	public static final int		UNISYS_SIDE				    =33882;	/* check side, 1=front 2=back */
...
/* 34016-34029 are reserved for ANSI IT8 TIFF/IT <dkelly@etsinc.com) */
	...
	public static final int 	IT8BITSPERRUNLENGTH	=34020;	/* # of bits in int run */
...
/* Note: quality level is on the IJG 0-100 scale.  Default value is 75 */
	public static final int		JPEGCOLORMODE		=65538;	/* Auto RGB<=>YCbCr convert? */
...
/* Note: default is JPEGTABLESMODE_QUANT | JPEGTABLESMODE_HUFF */
	...
	public static final int		PIXARLOGDATAFMT		=65549;	/* PixarLogCodec I/O data sz */
...
/* 65550-65556 are allocated to Oceana Matrix <dev@oceana.com> */
	...
	public static final int 	DCSCORRECTMATRIX    =65553;   /* color correction values */
...
/* Note: quality level is on the ZLIB 1-9 scale. Default value is -1 */
	...
	public static final int		PIXARLOGQUALITY		=65558;	/* PixarLog uses same scale */
/* 65559 is allocated to Oceana Matrix <dev@oceana.com> */
	public static final int 	DCSCLIPRECTANGLE	=65559;	/* area of image to acquire */
	...
	public Tag( int n ) {
		id = n;
		if (!IsStandard()) {
			logger.warn("WARNING: Non-Standard Tag {}", Integer.valueOf(n) );
		}
	}
