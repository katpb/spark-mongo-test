...
public class BMPFile extends Component {
    private Logger logger = LoggerFactory.getLogger(BMPFile.class);
    //--- Private constants
    ...
    public void saveBitmap (String parFilename, int[] imagePix, int
        ...
        try {
            ...
            logger.error("Error saving bitmap", saveEx);
        }

    }

    public void saveBitmap (OutputStream parFile, int[] imagePix, int
                            parWidth, int parHeight) {
    ...
    private void writeBitmap () {
	    ...
	    //--- Update the size of the file
            ...
            logger.error("Error writing bitmap", wb);
        }
    ...
    private void writeBitmapFileHeader () {
        ...
        try {
            ...
            logger.error("Error writing bitmap header", wbfh);
        }
    ...
    private void writeBitmapInfoHeader () {
        ...
        try {
            ...
            logger.error("Error writing bitmap header", wbih);
        }
