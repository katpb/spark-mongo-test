 ...
 * @author  Bhanu_N2
 */
public class TransOperation implements java.io.Serializable {
    static final long serialVersionUID = -7534490426052752913L;
    
    private transient String name;
    
    /** Private constructor - do not allow subclassing
     * @param name transaction operation's name
     */
    private TransOperation(String name) {
        this.name = name;
    }
    
    /** Override toString() method to provide the transaction operation's name
    ...
    /** Type-safe enum to represent addition of entities to the transaction object graph
     */    
    public static TransOperation ADDITION     = new TransOperation("ADDITION");
    /** Type-safe enum to represent removal of entities from the transaction object graph
     */    
    public static TransOperation REMOVAL   = new TransOperation("REMOVAL");
    /** Type-safe enum to represent modification of existing entities from the transaction object graph
     */    
    public static TransOperation MODIFICATION   = new TransOperation("MODIFICATION");    
    
    // The 4 declarations below are necessary for serialization
    private static int nextOrdinal = 0;
    private final int ordinal = nextOrdinal++; //Transaction operation; auto-incremented
    private static final TransOperation[] VALUES = {
