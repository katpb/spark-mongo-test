...
/** Primary key class for NetEBTConfig
 *  @author linda_t1
 * 	ADS Network Version
*/
public class NetEBTConfigPK implements IEntityPK {
    ...
    public NetEBTConfigPK() {
    }

    /** Constructor
     * @param recordNr record number number
     */    
    public NetEBTConfigPK(short recordNr) {
    ...
    /** Method to compare two NetEBTConfigPK objects for equality
     * @param obj object to compare with
     * @return true if the current and compared objects represent the same record number
     */    
    public boolean equals(IEntityPK obj) {
        if (obj instanceof NetEBTConfigPK) {
            NetEBTConfigPK dObj = (NetEBTConfigPK)obj;
