...
class DataType {
	...
	public DataType ( int n ) {
		...
		if ( n < MINIMUM || n > MAXIMUM ) {
			logger.warn( "WARNING: Unknown Data Type {}", Integer.valueOf(n) );
		}
	}
	...
	public int size ( int n ) {
		...
		switch (n) {
			...
			case ASCII:
			case SBYTE:
			case UNDEFINED:	size = 1; break; 
			case SHORT:
			case SSHORT:		size = 2; break; 
			case LONG:
			case SLONG:
	...
	public String toString( int n) {
		String s = "...";
		switch (n) {
			case NOTYPE:		s = "NOTYPE "; break; 
			case BYTE:	 		s = "BYTE   "; break; 
			case ASCII:			s = "ASCII  "; break; 
			case SBYTE:			s = "SBYTE  "; break; 
			case UNDEFINED:	s = "UNDEFINED "; break; 
			case SHORT:			s = "SHORT  "; break; 
			case SSHORT:		s = "SSHORT "; break; 
			case LONG:			s = "LONG   "; break; 
			case SLONG:			s = "SLONG  "; break; 
			case FLOAT:			s = "FLOAT  "; break; 
			case RATIONAL:	s = "RATIONAL "; break; 
			case SRATIONAL:	s = "SRATIONAL "; break; 
