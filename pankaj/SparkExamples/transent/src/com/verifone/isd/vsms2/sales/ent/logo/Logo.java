...
/**
 * Entity class for logo
 *
 *  @author "mailto:bhanu_n2@verifone.com"
 */
public class Logo implements IEntityObject, ISalesEntityVisitable {
    static final long serialVersionUID = -3362842558799120945L;
    /** Maximum logos
     */    
    public static final int MAX_LOGOS = 20;
    ...
    public void validate() throws Exception {
        if (!isPKValid()) {
            throw new Exception("Invalid logo: " +this.ID);            
        }
    }
