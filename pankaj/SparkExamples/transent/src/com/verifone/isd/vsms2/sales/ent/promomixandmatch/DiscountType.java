...
public class DiscountType implements java.io.Serializable {
     ...
     */
    private DiscountType(String name, String gemproCode) {
        this.name = name;
     ...
     * 'Package price' type
     */
    public static DiscountType PACKAGE_PRICE = new DiscountType("PACKAGE_PRICE", "P");
    /**
     * 'Discount percent' type
     */
    public static DiscountType DISCOUNT_PERCENT    = new DiscountType("DISCOUNT_PERCENT", "E");
    /**
     * 'Discount amount' type
     */
    public static DiscountType DISCOUNT_AMOUNT    = new DiscountType("DISCOUNT_AMOUNT", "A");
    ...
    private static final DiscountType[] VALUES = {
        PACKAGE_PRICE, DISCOUNT_PERCENT, DISCOUNT_AMOUNT
    };
    ...
    public static DiscountType getForGemproCode(String gemproCode) {
