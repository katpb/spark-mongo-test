 ...
 * a Mop item on the Topaz screen. This button can be displayed as part of
 * either ParkedMenuPanel or ItemPanel.
 *
 * @author T_pankajm2
 * @version 2.0
 */
public class MopButton extends NonFunctionButton {
	 ...
	 * @param mopNr      - mop primary key.
	 */
	public MopButton(int id, String bgColor, String lableColor, String textLine1, String textLine2, boolean isInactive,
			Image image, MopPK mopNr) {
		super(id, bgColor, lableColor, textLine1, textLine2, isInactive, SoftKeyType.MOP, image, mopNr);
	}
