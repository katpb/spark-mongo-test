...
/**
 * Tiff decoder class.
 * It can decompress raw, packbits, Group 3 1D, Group4, and JPEG
 *
...
public class Tiff
{
    private Logger logger = LoggerFactory.getLogger(Tiff.class);
    ...
    public void write( java.io.RandomAccessFile raf ) throws IOException
    {
        ...
        MotorolaIntelInputFilter out =
                                 new MotorolaIntelInputFilter( raf,
                                                               (header.byteOrder ==
                                                                Header.TIFF_LITTLEENDIAN) );
    ...
    public void read( byte[] bytesArray ) throws IOException
    {
        ...
        while ( offset != 0 )
        {
            ...
            {
                logger.warn(
                        "Oop, I was cheating and only allowed for 10 pages in a tif file" );
