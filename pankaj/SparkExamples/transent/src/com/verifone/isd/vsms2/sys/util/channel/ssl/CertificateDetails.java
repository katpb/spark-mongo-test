...
public class CertificateDetails {
	...
	public CertificateDetails(int keySize, String commonName, String organizationalUnit, 
			String organization, String city, String state, String country, String alias,
			String password, int validity, String keyPairGeneratorAlgorithm, String signatureAlgorithm) {
		super();
